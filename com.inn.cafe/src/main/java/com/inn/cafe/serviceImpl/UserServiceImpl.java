        ...
        try {
            if (validateSignUpMap(requestMap)) {
                ...
                if (Objects.isNull(user)) {
                    ...
                    return CafeUtils.getResponseEntity("Succesfulyy Registered.", HttpStatus.OK);
                } else {
        ...
        try{
            ...
            if(auth.isAuthenticated()){
                if(customerUsersDetailsService.getUserDetail().getStatus().equalsIgnoreCase("true")){
                    return new ResponseEntity<String>("{\"token\":\""+ jwtUtils.generateToken(customerUsersDetailsService.getUserDetail().getEmail(),
    ...
    public ResponseEntity<String> changePassword(Map<String, String> requestMap) {
        try{
            ...
            if(!userObj.equals(null)){
                ...
                return CafeUtils.getResponseEntity("Incorred Old password", HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<String> forgetPassword(Map<String, String> requestMap) {
        try{
            ...
            if(!Objects.isNull(user) && !Strings.isNullOrEmpty(user.getEmail())){
                emailUtils.forgetMail(user.getEmail(), "Credentials by Bistro Management System", user.getPassword());
